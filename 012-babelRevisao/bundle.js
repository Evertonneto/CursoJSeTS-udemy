...
var PessoaFisica = /*#__PURE__*/function (_Pessoa) {
  function PessoaFisica(nome, cpf) {
    ...
    _this = _callSuper(this, PessoaFisica, [nome]);
    _this.cpf = cpf;
    return _this;
  }
  _inherits(PessoaFisica, _Pessoa);
  return _createClass(PessoaFisica, [{
    key: "falar",
    value: function falar() {
      console.log("Meu nome \xE9 ".concat(this.nome, " e meu cpf \xE9 ").concat(this.cpf));
    }
  }]);
}(Pessoa);
var p1 = new Pessoa('João');
p1.falar();
var p2 = new PessoaFisica('Maria', '123456789');
p2.falar();
